...
window = Tk()
window.geometry("295x360")
window.resizable(0, 0)
window.title("Tkinter-Calculator")
window.config(background="#0f3c4c")
...
text_display.grid(row=0, column=0, columnspan=20, padx=8, pady=20)
...
Bt8.grid(row=2, column=2, padx=2)
Bt9.grid(row=2, column=3, padx=2)

Bt4.grid(row=3, column=1)
Bt5.grid(row=3, column=2)
Bt6.grid(row=3, column=3)

Bt1.grid(row=4, column=1, pady=5)
